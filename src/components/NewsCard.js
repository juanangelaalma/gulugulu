...
const NewsCard = ({ link, title, source, published }) => {
  return (
    <div className="w-[232px] h-[150px] md:w-[50%] md:h-[143px] border border-[#3C4043] rounded-xl overflow-hidden md:flex md:flex-row-reverse md:border-b-0 md:border-x-0 md:rounded-none md:justify-between md:items-center md:pr-2">
      ...
      <div className="flex flex-col p-3 justify-between h-[100%] md:h-[100%] md:w-[100%] md:items-start">
        <div className="flex flex-col justify-start space-y-1">
          <a className="text-xs text-dark-white">{source?.href}</a>
          <a href={link}>
